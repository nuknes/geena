...
# 08 September 2026 - Bottles Shortcut Manager v.9.3
...
if [ -z "$1" ]; then
    echo ""
    echo "========================================================"
    echo "   Bottles Shortcut Manager (Direct Launch)   v.9.3    "
    echo "========================================================"
    echo ""
    echo "1) Create / Update a single game shortcut"
    echo "2) Refresh / Update all games from library.yml"
    echo "3) Remove a game shortcut & icon"
    echo "4) Sync check, find missing or stale shortcuts"
    echo "5) Exit without changes"
    echo ""
    echo "Note: For 1 and 3, type the exact game name including space(s), no quotes"
    echo ""
